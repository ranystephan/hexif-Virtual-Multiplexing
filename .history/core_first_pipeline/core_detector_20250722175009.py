...
# Try different import locations for peak_local_maxima based on scikit-image version
try:
    ...
    try:
        ...
        # Fallback: use feature.peak_local_maxima directly
        peak_local_maxima = feature.peak_local_maxima
