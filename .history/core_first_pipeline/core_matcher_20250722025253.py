...
class CoreMatcher:
    ...
    def match_cores(self, he_detection_results: Dict, orion_detection_results: Dict) -> Dict:
        ...
        filtered_matches = self._filter_matches(matches_with_quality)
        ...
        results = {
            ...
            'unmatched_he_cores': self._find_unmatched_cores(he_cores, filtered_matches, 'he'),
            'unmatched_orion_cores': self._find_unmatched_cores(orion_cores, filtered_matches, 'orion'),
            'matching_statistics': self._calculate_matching_statistics(filtered_matches, he_cores, orion_cores),
            'config': self.config.__dict__
        }
        
        logger.info(f"Successfully matched {len(filtered_matches)} core pairs")
        return results
