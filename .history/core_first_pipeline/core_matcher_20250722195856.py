...
class CoreMatcher:
    ...
    def _match_cores_traditional(self, he_detection_results: Dict, orion_detection_results: Dict) -> Dict:
        ...
        high_quality_matches = self._filter_matches(matches_with_quality)
        
        # Compute matching statistics
        statistics = self._calculate_matching_statistics(matches_with_quality, he_cores, orion_cores)
