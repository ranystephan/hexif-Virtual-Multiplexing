    ...
    try:
        ...
        try:
            if processed_img.ndim == 3 and processed_img.shape[0] <= 50 and processed_img.shape[0] != 3:
                # Multi-channel format (not RGB) - create two versions
                ...
                # For H&E images, convert to grayscale for better VALIS compatibility with DAPI
                ...
                try:
                    ...
                    logger.error("Not enough memory to process large H&E image")
