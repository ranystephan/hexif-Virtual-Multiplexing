...
\begin{frame}{Quantile Scaling \& Log Transform}
  \begin{columns}[T]
    ...
    \begin{column}{0.42\textwidth}
      ...
      \end{block}
      \vspace{0.5em}
      \includegraphics[width=\textwidth]{../output/data_summary_nov4/plots/channel_speckle_bar.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Adaptive Sampling Strategy}
  \begin{columns}[T]
    ...
    \begin{column}{0.44\textwidth}
      ...
      \end{block}
      \vspace{0.6em}
      \includegraphics[width=\textwidth]{../output/data_summary_nov4/plots/channel_speckle_vs_coverage.png}
    \end{column}
  \end{columns}
\end{frame}
