            ...
            with tempfile.TemporaryDirectory() as tmpdir:
                ...
                try:
                    ...
                    imwrite(
                        ...
                        planarconfig='contig',     # Interleaved format
                        compress=0                 # No compression for compatibility
                    )
    ...
    class QualityController:
        ...
        def create_quality_plots(self, registration_results: List[Dict], output_dir: str):
            ...
            try:
                ...
                # Create simple metric plots instead of image overlays to avoid shape issues
