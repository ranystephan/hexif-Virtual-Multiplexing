...
def make_loaders(args):
    ...
    # Use single-threaded loading for debugging performance issues
    # Multi-threading seems to cause severe slowdowns
    total_patches = len(train_ds)
    safe_workers = 0  # Single-threaded for now
    logging.info(f"Using single-threaded data loading to avoid performance issues")
