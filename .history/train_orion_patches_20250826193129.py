...
def main():
    ...
    p.add_argument("--batch_size", type=int, default=16)  # Reasonable batch size for 512x512 patches
    ...
    p.add_argument("--patches_per_image", type=int, default=4)  # Just 4 patches per core (2x2 grid)
    p.add_argument("--patches_per_image_val", type=int, default=4)
