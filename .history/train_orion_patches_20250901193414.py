...
class BCEDiceLoss(nn.Module):
    def __init__(self, bce_w=0.7, dice_w=0.3, smooth=1.0, per_channel_weights: torch.Tensor = None):
        super().__init__()
        self.bce_w = bce_w
        self.dice_w = dice_w
        self.smooth = smooth
...
")
    crit = BCEDiceLoss(bce_w=0.7, dice_w=0.3, per_channel_weights=per_ch_weights)
