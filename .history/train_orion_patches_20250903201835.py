...
def main():
    ...
    backbone = 'convnext_tiny' if (args.batch_size >= 64 and torch.cuda.get_device_properties(0).total_memory <= 12*1024**3) else 'convnext_small'
    net = ConvNeXtHead(num_outputs=20, backbone=backbone)
