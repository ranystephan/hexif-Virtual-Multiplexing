...
def main():
    ...
    # Ensure both files are in the same directory for VALIS
    if orion_path.parent != src_dir:
        raise ValueError("H&E and Orion files must be in the same directory for VALIS registration")
