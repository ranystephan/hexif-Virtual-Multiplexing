...
def main():
    ...
    if he_path.parent == orion_path.parent:
        ...
        try:
            ...
            # Initialize VALIS registrar directly with source directory
            logger.info(f"Initializing VALIS with src_dir={src_dir}, dst_dir={valis_output_dir}")
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            try:
                ...
                # Initialize VALIS registrar with temporary directory
                logger.info(f"Initializing VALIS with src_dir={tmp_dir}, dst_dir={valis_output_dir}")
                logger.info(f"Image list: {[he_name, orion_name]}")
